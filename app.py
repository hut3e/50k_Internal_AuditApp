...
def display_logos():
    ...
    with logo_container:
        ...
        st.title("ISO 50001:2018 TRAINING AUDIT APP")
...
def display_welcome_screen():
    ...
    st.header("🎯 Chào mừng Học viên tham dự khóa Đào tạo tiêu chuẩn ISO 50001:2018!")
...
def setup_sidebar():
    ...
    with st.sidebar:
        st.title("🎯 Hệ thống kiểm tra sau Đào tạo nhận thức ISO 50001:2018")
...
def main():
    ...
    # Cấu hình trang
    st.set_page_config(
        page_title="Hệ thống kiểm tra học viên sau Đào tạo nhận thức ISO 50001:2018",
        page_icon="🎯",
        layout="wide",
